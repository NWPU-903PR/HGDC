...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--annotation',
                        ...
                        dest='annotation',
                        default='../data/pancancer/TCGA/gene_mutation/gencode.v28.basic.annotation.gff3',
                        type=str
                        )
    parser.add_argument('-md', '--methylation_dir',
                        help='Path to methylation download dir',
                        dest='meth_dir',
                        default= '../data/pancancer/TCGA/DNA_methylation/special_cancer/BLCA/blca_normal/',
                        type=str,
                        )
    ...
    parser.add_argument('-o', '--output',
                        ...
                        dest='output',
                        default='../data/pancancer/TCGA/DNA_methylation/dna_methy_matrix_normal.tsv',
                        type=str,
    ...
    if args.tcga_annot and args.fiveprime: # use TCGA annotations and only fiveprime transcript
        ...
        cpg_genemap_file = os.path.join(os.path.dirname(args.annotation), 'cpg2genemap_normal.tsv')
